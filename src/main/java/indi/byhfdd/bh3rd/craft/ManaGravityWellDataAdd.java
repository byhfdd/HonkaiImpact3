...
public class ManaGravityWellDataAdd extends ManaGravityWellData {//引力井
    public static void init() {
        ...
        list.add(new ItemStack[]{AC,GC, AC, GC,GC, AC, GC, AC, SE, SE, SE, SE, new ItemStack(ItemLoader.StigmataResonance, 1, 0)});
    }
}