...
public class ItemLoader {
    ...
    public static final Item Bh3rd = new Bh3rd();
    ...
    //圣痕
    //物理
    public static final AccessoryCore ImmaculateFairy = new AccessoryCore("ImmaculateFairy",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.physicalAttack, 500f),//物理攻击力
    ...
    public static final AccessoryCore QuantumWaltz = new AccessoryCore("QuantumWaltz",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.physicalAttack, 375f),//物理攻击力
    ...
    public static final AccessoryCore Renaissance = new AccessoryCore("Renaissance",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.physicalAttack, 250),//物理攻击力
    ...
    public static final AccessoryCore RussianCzar = new AccessoryCore("RussianCzar",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.physicalAttack, 125f),//物理攻击力
    ...
    public static final AccessoryCore BaroqueDramaSaint = new AccessoryCore("BaroqueDramaSaint",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.magicAttack, 500f),//魔法攻击力:
            new IMagicEffect(MagicItemType.attackMultiplier,0.20f),//造成的伤害
            new IMagicEffect(MagicItemType.crit,20),//暴击率
            new IMagicEffect(MagicItemType.critDamage,0.20f),//暴击伤害:
            new IMagicEffect(MagicItemType.penetrate,20)//穿透值:
    });
    public static final AccessoryCore SwordHeart = new AccessoryCore("SwordHeart",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.magicAttack, 375f),//魔法攻击力:
            new IMagicEffect(MagicItemType.attackMultiplier,0.15f),//造成的伤害
            new IMagicEffect(MagicItemType.crit,15),//暴击率
            new IMagicEffect(MagicItemType.critDamage,0.15f),//暴击伤害:
            new IMagicEffect(MagicItemType.penetrate,15)//穿透值:
    });
    public static final AccessoryCore Artist = new AccessoryCore("Artist",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.magicAttack, 250f),//魔法攻击力:
            new IMagicEffect(MagicItemType.attackMultiplier,0.10f),//造成的伤害
            new IMagicEffect(MagicItemType.crit,10),//暴击率
            new IMagicEffect(MagicItemType.critDamage,0.10f),//暴击伤害:
            new IMagicEffect(MagicItemType.penetrate,10)//穿透值:
    });
    public static final AccessoryCore KnifeLegend = new AccessoryCore("KnifeLegend",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.magicAttack, 125f),//魔法攻击力:
            new IMagicEffect(MagicItemType.attackMultiplier,0.05f),//造成的伤害
            new IMagicEffect(MagicItemType.crit,5),//暴击率
            new IMagicEffect(MagicItemType.critDamage,0.05f),//暴击伤害:
            new IMagicEffect(MagicItemType.penetrate,5)//穿透值:
    ...
    public static final AccessoryCore TinyMoments = new AccessoryCore("TinyMoments",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.manaMax, 8000f),//最大法力:
    ...
    public static final AccessoryCore LawIce = new AccessoryCore("LawIce",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.manaMax, 6000f),//最大法力:
    ...
    public static final AccessoryCore ArcticExplorer = new AccessoryCore("ArcticExplorer",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.manaMax, 4000),//最大法力:
    ...
    public static final AccessoryCore LceShadowButterfly = new AccessoryCore("LceShadowButterfly",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.manaMax, 2000),//最大法力:
    ...
    public static final AccessoryCore SingSoftly = new AccessoryCore("SingSoftly",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.HP, 20000f),//最大生命值
    ...
    public static final AccessoryCore PrincessLilliput = new AccessoryCore("PrincessLilliput",new IMagicEffect[]{
            new IMagicEffect(MagicItemType.HP, 15000f),//最大生命值
    ...
    public static final AccessoryCore SunProphet = new AccessoryCore("SunProphet",new IMagicEffect[]{
                new IMagicEffect(MagicItemType.HP, 10000f),//最大生命值
    ...
    public static final AccessoryCore AncientWill = new AccessoryCore("AncientWill",new IMagicEffect[]{
                new IMagicEffect(MagicItemType.HP, 5000f),//最大生命值
