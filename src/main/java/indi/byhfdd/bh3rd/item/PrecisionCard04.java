...
public class PrecisionCard04 extends ItemBasicBagWeight {
    public PrecisionCard04() {
        super(1, "PrecisionCard04");
        this.setTextureName("bh3rd:PrecisionCard04");//材质路径
        this.setCreativeTab(CreativeTabsLoader.tabFMLTutor);//物品栏
    }

    public List getBagItem() {
        List list = new ArrayList();
        list.add(new ItemStack(WeaponLoader.JM));
        list.add(new ItemStack(WeaponLoader.SYJ));
