...
public class PrecisionCard05 extends ItemBasicBagWeight {

    public PrecisionCard05() {
        super(1, "PrecisionCard05");
        this.setTextureName("bh3rd:PrecisionCard05");// 材质路径
        this.setCreativeTab(CreativeTabsLoader.tabFMLTutor);// 物品栏
    }

    public List<ItemStack> getBagItem() {
        List<ItemStack> list = new ArrayList<>();
        list.add(new ItemStack(WeaponLoader.FLD));
        list.add(new ItemStack(WeaponLoader.TJZY));
        list.add(new ItemStack(WeaponLoader.CRY));
        list.add(new ItemStack(WeaponLoader.CBZ));
        list.add(new ItemStack(WeaponLoader.DZQL));
        list.add(new ItemStack(WeaponLoader.CNZY));
