...
public class PrecisionCard01 extends ItemBasicBagWeight {
    ...
    public List<ItemStack> getBagItem() {
        ...
        list.add(new ItemStack(WeaponLoader.XSZY));// 武器
        list.add(new ItemStack(WeaponLoader.BAX));// 武器
        list.add(new ItemStack(WeaponLoader.XYZM));// 武器
        list.add(new ItemStack(WeaponLoader.BAZF));
        list.add(new ItemStack(WeaponLoader.HSZS));
        list.add(new ItemStack(WeaponLoader.AXYW));
