...
public class PrecisionCard06 extends ItemBasicBagWeight {

    public PrecisionCard06() {
        super(1, "PrecisionCard06");
        this.setTextureName("bh3rd:PrecisionCard06");
        this.setCreativeTab(CreativeTabsLoader.tabFMLTutor);
    }

    public List<ItemStack> getBagItem() {
        List<ItemStack> list = new ArrayList<>();
        list.add(new ItemStack(WeaponLoader.YYQW));
        list.add(new ItemStack(WeaponLoader.JRTG));
