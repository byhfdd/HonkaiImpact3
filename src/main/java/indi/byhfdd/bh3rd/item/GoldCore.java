...
public class GoldCore extends Item implements ICoins{
    ...
    public void addSound(World world, EntityPlayer player) {
        ...
        switch (c) {
            case 0:
                world.playSoundAtEntity(player, "manametalmod:item.coin1", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F);
                break;
            case 1:
                world.playSoundAtEntity(player, "manametalmod:item.coin2", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F);
                break;
            case 2:
                world.playSoundAtEntity(player, "manametalmod:item.coin3", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F);
        }
