...
@Mod(modid = Main.MODID,name = Main.NAME,version = Main.VERSION,dependencies = Main.dependencies,acceptedMinecraftVersions = "[1.7.10]")
...
public class Main {
    ...
    @SidedProxy(clientSide = "indi.byhfdd.bh3rd.ClientProxy",
                serverSide = "indi.byhfdd.bh3rd.CommonProxy")
